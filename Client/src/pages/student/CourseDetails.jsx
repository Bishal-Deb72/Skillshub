...
function CourseDetails() {
      ...
      <div className='absolute top-0 left-0 w-full h-section-height -z-1 bg-gradient-to-b from-cyan-100/70'>
        ...
        <div className='max-w-xl z-10 text-gray-500'>
          ...
          <p className='pt-4 md:text-base text-sm'
           ...
           <p className='text-sm'>Course by <span className='text-blue-600 underline'>GreateStack</span></p>
 ...
 rounded-t md:rounded-none overflow-auto bg-white min-w-[300px] sm:min-w-[420px]'>
          ...
          <div className='p-5'>
            <div className='flex items-center gap-2 '>
              ...
              <img className='w-3.5'
                src={assets.time_clock_icon} alt="time left clock icon" />
            ...
            <div className='flex items-center text-sm md:text-default gap-4 pt- md:pt-4 text-gray-500'>
