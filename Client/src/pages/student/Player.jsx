            ...
            {playerData ? (
              <div className='md:mt-10'>
                ...
                <div className='flex justify-between items-center mt-1'>
                  ...
                  <button onClick={()=>markLectureAsCompleted(playerData.lectureId)} className='text-blue-600'>{progressData && progressData.lectureComleted.includes(playerData.lectureId) ? 'completed' : 'Mark Complete'}</button>
                </div>
